...
export const DEFAULT_CONFIG: AppConfig = {
  ...
  // Telemetry is permanently disabled in this fork. The daemon also
  // normalizes legacy and Web-provided values to false before use.
...
export function mergeDaemonConfig(
  ...
  // Telemetry-free fork: never mint an analytics installation id and never
  // re-enable metrics/content while merging daemon state into localStorage.
